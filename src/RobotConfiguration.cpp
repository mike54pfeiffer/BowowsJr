...
motor RightIntakeMotor = motor(vex::PORT12, vex::gearSetting::ratio18_1,false);
motor LeftIntakeMotor = motor(vex::PORT2, vex::gearSetting::ratio18_1,false);
...
motor RightArmMotor = motor(vex::PORT16, vex::gearSetting::ratio18_1, true);
